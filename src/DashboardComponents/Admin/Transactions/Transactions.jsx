    ...
    <div className="max-w-7xl mx-auto p-2 space-y-4">
      ...
      <div className="border-b border-slate-800/60 pb-4">
        <h2 className="text-base font-bold text-white flex items-center gap-2">
          <CreditCard className="size-4.5 text-emerald-400" /> Transaction
          Ledger
        </h2>
        <p className="text-xs text-slate-400 mt-0.5">
          Real-time ledger monitor tracking operational inflows, settlement
          verification, and pipeline failures.
        </p>
      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4">
                      <span
                        className={`inline-flex items-center font-mono font-bold tracking-tight px-2 py-0.5 rounded text-[11px]
                      ...
                      >
                        ...
                        {Number(tx.price.replace("$", "")).toFixed(2)}
                      </span>
                    </td>
